 ...
 */
export const dijkstraBfs = (graph: AdjacencyProvider, edgeCostProvider: ProvidesEdgeAttribute<number, number>,
    start: number, destination?: number,
    addFrontier?: (node: number) => void): Map<number, number | null> => {
